...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_F2,         spawn,          {.v = (const char*[]){ "mounter", NULL } } },
	{ MODKEY,                       XK_F3,         spawn,          {.v = (const char*[]){ "unmounter", NULL } } },
	{ MODKEY,                       XK_F4,         spawn,          SHCMD("remaps") },
	{ MODKEY,                       XK_space,      zoom,           {0} },
	{ MODKEY|ShiftMask,             XK_space,      togglefloating, {0} },
	{ 0,                            XK_Print,      spawn,          {.v = (const char*[]){ "scrot ~/pics/%Y-%m-%d-%H%M%S-scrot.png", NULL } } },
	{ ShiftMask,                    XK_Print,      spawn,          {.v = (const char*[]){ "sleep 0.2; scrot ~/pics/%Y-%m-%d-%H%M%S-scrot.png", NULL } } },
