...
static Key keys[] = {
  ...
  { MODKEY,                       XK_p,            spawn,         SHCMD("cmus-remote -u") },
  { MODKEY,                       XK_bracketleft,  spawn,         SHCMD("cmus-remote -k -10") },
  { MODKEY|ShiftMask,             XK_bracketleft,  spawn,         SHCMD("cmus-remote -k -60") },
  { MODKEY,                       XK_bracketright, spawn,         SHCMD("cmus-remote -k +10") },
  { MODKEY|ShiftMask,             XK_bracketright, spawn,         SHCMD("cmus-remote -k +60") },
  ...
  { MODKEY,                       XK_n,            spawn,         SHCMD(TERMINAL " -e vim ~/wiki/index.adoc") },
  { MODKEY,                       XK_m,            spawn,         SHCMD(TERMINAL " -e cmus") },
  { MODKEY|ShiftMask,             XK_m,            spawn,         SHCMD("pamixer -t; kill -44 $(pidof dwmblocks)") },
  { MODKEY,                       XK_comma,        spawn,         SHCMD("cmus-remote -r") },
  { MODKEY|ShiftMask,             XK_comma,        spawn,         SHCMD("cmus-remote -R") },
  { MODKEY,                       XK_period,       spawn,         SHCMD("cmus-remote -n") },
  { MODKEY|ShiftMask,             XK_period,       spawn,         SHCMD("cmus-remote -S") },
  ...
  { MODKEY,                       XK_Insert,       spawn,         SHCMD("xdotool type $(grep -v '^#' ~/.local/share/arisa/snippets | dmenu -i -l 50 | cut -d' ' -f1)") },

  { MODKEY,     XK_F4,    spawn,    SHCMD(TERMINAL " -e pulsemixer; kill -44 $(pidof dwmblocks)") },
  { MODKEY,     XK_F5,    xrdb,     {.v = NULL } },
  { MODKEY,     XK_F6,    spawn,    {.v = (const char*[]){ "torwrap", NULL } } },
  { MODKEY,     XK_F7,    spawn,    {.v = (const char*[]){ "td-toggle", NULL } } },
  { MODKEY,     XK_F8,    spawn,    {.v = (const char*[]){ "displayselect", NULL } } },
  ...
  { 0, XF86XK_AudioRewind,      spawn,    SHCMD("cmus-remote -k -10") },
  { 0, XF86XK_AudioForward,     spawn,    SHCMD("cmus-remote -k +10") },
